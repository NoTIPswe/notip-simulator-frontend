...
const (
	...
	errExpected404           = "expected error on 404, got nil"
	errExpectedDecode        = "expected decode error, got nil"
	invalidJSONPayload       = "not-json"
	invalidJSONPayloadBroken = "{invalid-json"
...
func TestCreateGatewayServerError(t *testing.T) {
	_, c := newTestServer(t, func(w http.ResponseWriter, r *http.Request) {
...
func TestStartGatewaySuccess(t *testing.T) {
	_, c := newTestServer(t, func(w http.ResponseWriter, r *http.Request) {
		assertMethod(t, r, http.MethodPost)
		assertPath(t, r, pathGatewaysPrefix+gwUUID1+"/start")
		w.WriteHeader(http.StatusNoContent)
	})
	if err := c.StartGateway(gwUUID1); err != nil {
		t.Fatalf(errFmtUnexpected, err)
	}
}

func TestStartGatewayAlreadyRunning409(t *testing.T) {
	_, c := newTestServer(t, func(w http.ResponseWriter, r *http.Request) {
...
func TestStopGatewaySuccess(t *testing.T) {
	_, c := newTestServer(t, func(w http.ResponseWriter, r *http.Request) {
		assertMethod(t, r, http.MethodPost)
		assertPath(t, r, pathGatewaysPrefix+gwUUID1+"/stop")
		w.WriteHeader(http.StatusNoContent)
	})
	if err := c.StopGateway(gwUUID1); err != nil {
		t.Fatalf(errFmtUnexpected, err)
	}
}

func TestDeleteGatewaySuccess(t *testing.T) {
	_, c := newTestServer(t, func(w http.ResponseWriter, r *http.Request) {
		assertMethod(t, r, http.MethodDelete)
		assertPath(t, r, pathGatewaysPrefix+gwUUID1)
		w.WriteHeader(http.StatusNoContent)
	})
	if err := c.DeleteGateway(gwUUID1); err != nil {
		t.Fatalf(errFmtUnexpected, err)
	}
}
...
func TestAddSensorGatewayNotFound(t *testing.T) {
	_, c := newTestServer(t, func(w http.ResponseWriter, r *http.Request) {
		http.Error(w, errMsgNotFound, http.StatusNotFound)
	})
...
func TestDeleteSensorNotFound(t *testing.T) {
	_, c := newTestServer(t, func(w http.ResponseWriter, r *http.Request) {
		http.Error(w, errMsgNotFound, http.StatusNotFound)
	})
...
func TestDisconnectSuccess(t *testing.T) {
	_, c := newTestServer(t, func(w http.ResponseWriter, r *http.Request) {
		assertMethod(t, r, http.MethodPost)
		assertPath(t, r, pathGatewaysPrefix+gwUUID1+"/anomaly/disconnect")
	...
	if err := c.Disconnect(gwUUID1, 5); err != nil {
		t.Fatalf(errFmtUnexpected, err)
	}
}

func TestDisconnectGatewayNotFound(t *testing.T) {
	_, c := newTestServer(t, func(w http.ResponseWriter, r *http.Request) {
		http.Error(w, errMsgNotFound, http.StatusNotFound)
	})
...
func TestInjectNetworkDegradationWithPacketLoss(t *testing.T) {
	_, c := newTestServer(t, func(w http.ResponseWriter, r *http.Request) {
		assertMethod(t, r, http.MethodPost)
		assertPath(t, r, pathGatewaysPrefix+gwUUID1+"/anomaly/network-degradation")
	...
	if err := c.InjectNetworkDegradation(gwUUID1, 10, 0.5); err != nil {
		t.Fatalf(errFmtUnexpected, err)
	}
}

func TestInjectNetworkDegradationDefaultPacketLoss(t *testing.T) {
	_, c := newTestServer(t, func(w http.ResponseWriter, r *http.Request) {
	...
	if err := c.InjectNetworkDegradation(gwUUID1, 5, 0); err != nil {
		t.Fatalf(errFmtUnexpected, err)
	}
}

func TestInjectOutlierWithValue(t *testing.T) {
	val := 999.9
	_, c := newTestServer(t, func(w http.ResponseWriter, r *http.Request) {
		assertMethod(t, r, http.MethodPost)
...
func TestInjectOutlierNoValue(t *testing.T) {
	_, c := newTestServer(t, func(w http.ResponseWriter, r *http.Request) {
		body, _ := io.ReadAll(r.Body)
		var req map[string]any
		_ = json.Unmarshal(body, &req)
...
func TestInjectOutlierSensorNotFound(t *testing.T) {
	_, c := newTestServer(t, func(w http.ResponseWriter, r *http.Request) {
		http.Error(w, errMsgNotFound, http.StatusNotFound)
	})
...
func TestGetGatewayErrorIncludesStatusAndBody(t *testing.T) {
	_, c := newTestServer(t, func(w http.ResponseWriter, r *http.Request) {
...
func TestCreateGatewayInvalidJSONResponse(t *testing.T) {
	_, c := newTestServer(t, func(w http.ResponseWriter, r *http.Request) {
		w.Header().Set(headerContentType, mediaTypeJSON)
		w.WriteHeader(http.StatusCreated)
		_, _ = w.Write([]byte(invalidJSONPayloadBroken))
	})
...
func TestListGatewaysInvalidJSONResponse(t *testing.T) {
	_, c := newTestServer(t, func(w http.ResponseWriter, r *http.Request) {
		w.Header().Set(headerContentType, mediaTypeJSON)
...
func TestBulkCreateGatewaysInvalidJSONResponse(t *testing.T) {
	_, c := newTestServer(t, func(w http.ResponseWriter, r *http.Request) {
		w.Header().Set(headerContentType, mediaTypeJSON)
		w.WriteHeader(http.StatusCreated)
		_, _ = w.Write([]byte(invalidJSONPayload))
...
func TestGetGatewayInvalidJSONResponse(t *testing.T) {
	_, c := newTestServer(t, func(w http.ResponseWriter, r *http.Request) {
		w.Header().Set(headerContentType, mediaTypeJSON)
		w.WriteHeader(http.StatusOK)
		_, _ = w.Write([]byte(invalidJSONPayload))
...
func TestAddSensorInvalidJSONResponse(t *testing.T) {
	_, c := newTestServer(t, func(w http.ResponseWriter, r *http.Request) {
		w.Header().Set(headerContentType, mediaTypeJSON)
		w.WriteHeader(http.StatusCreated)
		_, _ = w.Write([]byte(invalidJSONPayload))
...
func TestListSensorsInvalidJSONResponse(t *testing.T) {
	_, c := newTestServer(t, func(w http.ResponseWriter, r *http.Request) {
		w.Header().Set(headerContentType, mediaTypeJSON)
		w.WriteHeader(http.StatusOK)
		_, _ = w.Write([]byte(invalidJSONPayload))
